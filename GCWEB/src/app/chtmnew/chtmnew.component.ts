...
@Component({
  selector: 'app-chtmnew',
  templateUrl: './chtmnew.component.html',
  styleUrls: ['./chtmnew.component.css']
})
export class ChtmnewComponent implements OnInit {
