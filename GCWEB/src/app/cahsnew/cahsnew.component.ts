...
@Component({
  selector: 'app-cahsnew',
  templateUrl: './cahsnew.component.html',
  styleUrls: ['./cahsnew.component.css']
})

export class CahsnewComponent implements OnInit {
